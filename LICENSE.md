...
Additional Use Grant:  You may use, copy, modify, and create derivative
                       ...
                       include personal projects, academic and educational
                       use, evaluation, research, and contributions back to
                       this project.

                       You may also use the Licensed Work for a commercial
...
Change Date:           Four years from the publication date of each
                       ...
                       2030-09-08. Each subsequent tagged release starts
                       its own four-year clock from its own publication
                       date, recorded in that release's CHANGELOG entry.
...
The Business Source License (this document, excluding the Licensor and
Licensed Work parameters, but including the Additional Use Grant, Change
Date, and Change License above) is not an Open Source license. However,
the Licensed Work will eventually be made available under an Open Source
License, as stated in this License.

For the avoidance of doubt, this License does not grant you any right
under any trademark of the Licensor.

Terms

The Licensor hereby grants you the right to copy, modify, create
derivative works, redistribute, and make non-production use of the
Licensed Work, subject to the Additional Use Grant above and the
limitations below.
...
Résumé informel (sans valeur légale) / Informal summary (not legally binding)

🇫🇷 En clair : le code source est ouvert et lisible par tout le monde dès
...
légal ci-dessus (en anglais) fait foi en cas de litige.

🇬🇧 In plain terms: the source code is open and readable by anyone right
